export function getEmailTemplate(firstName, lastName, email, subject, message) {
...
export function getPlainTextTemplate(firstName, lastName, email, subject, message) {
    return `
